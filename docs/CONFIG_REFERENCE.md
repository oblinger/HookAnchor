...
Optional cloud service scanning. Currently supports Notion. (Note: planned to move to `scanner_settings` in a future release.)
...
| `doc_file_extensions` | string | `"pdf,doc,docx,xls,xlsx,ppt,pptx,txt,rtf,pages,numbers,key"` | Comma-separated file extensions that generate DOC-type commands |
